...
predictit_api = website.read()
predictit = json.loads(predictit_api)
...
x1 = "predictit: "+str(type(predictit))
x2 = 'predictit["Markets"]): '+str(type(predictit["Markets"]))
x3 = 'predictit["Markets"][0]): '+str(type(predictit["Markets"][0]))
x4 = 'predictit["Markets"][0]["Contracts"]: '+str(type(predictit["Markets"][0]["Contracts"]))
x5 = 'predictit["Markets"][0]["Contracts"][0]: '+str(type(predictit["Markets"][0]["Contracts"][0]))
x6 = 'Number of markets: '+str(len(predictit["Markets"]))
x7 = 'Number of contracts: '+str(contracts)
...
# markets = array.fromlist(data={"id":markets_id,"name":markets_name,"shortname":markets_shortname,"tickersymbol":markets_tickersymbol,"url":markets_url,"timestamp":markets_timestamp})
...
class MainPage(webapp2.RequestHandler):
    def get(self):
        ...
        self.response.write(x6)
        self.response.write(x7)
